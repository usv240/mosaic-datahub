...
Apache-2.0 licensed. See [docs/ADOPTION_GUIDE.md](docs/ADOPTION_GUIDE.md) for the path from zero-setup exploration to production controls and [SUBMISSION.md](SUBMISSION.md) for the concise judge narrative.
